...
export default function NotesPanel({ character, updatePath, t }) {
  return (
    <div className="grid gap-4 xl:grid-cols-2">
      <Panel title={t("panel.notes.personality.title")} kicker={t("panel.notes.personality.kicker")}>
      ...
      <Panel title={t("panel.notes.featuresAndNotes.title")} kicker={t("panel.notes.featuresAndNotes.kicker")}>
